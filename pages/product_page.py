...
class ProductPage(BasePage):
    """Product details page object for handling individual product interactions."""
    ...
    def product_name(self):
        return self.find_by_page_locator(
            'xpath=//div[@data-ta-section="ProductMainInfoDesktop"]//h1'
        )
    ...
    def add_to_cart_button(self):
        return self.find_by_locator(
            self.price_main_container(), '[data-ta="add-to-cart-btn"]'
        )
    ...
    def added_to_cart_window_go_to_cart_button(self):
        return self.find_by_locator(
            self.added_to_cart_window(), '[data-ta="go-to-cart"]'
        )

    def added_to_cart_window_continue_shopping_button(self):
        return self.find_by_locator(
            self.added_to_cart_window(), '[data-ta="close-drawer"]'
        )
